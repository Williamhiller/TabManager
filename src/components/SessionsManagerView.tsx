...
const sessionLabelMap = {
  ...
  ru: {
    allWindows: 'Сохранить все окна',
    appendCurrent: 'Добавить в текущее окно',
    cancel: 'Отмена',
    currentWindow: 'Сохранить текущее окно',
    deleteLabel: 'Удалить снимок',
    deleting: 'Удаление снимка…',
    duplicateConfirm: 'Большинство вкладок этого снимка уже открыты. Восстановить всё равно?',
    edit: 'Редактировать снимок',
    empty: 'Нет сохранённых снимков.',
    emptyHint: 'Сохраните текущее окно или все окна для восстановления позже.',
    collapse: 'Свернуть',
    expand: 'Развернуть',
    latestSnapshot: 'Автосохранение',
    manual: 'Вручную',
    openTab: 'Открыть эту вкладку',
    pinned: 'Закреплена',
    muted: 'Приглушена',
    recoverLatest: 'Восстановить последнее автосохранение',
    restore: 'Восстановить в новом окне',
    restorePartial: 'Восстановлено с ошибками некоторых вкладок',
    restoring: 'Восстановление снимка…',
    save: 'Сохранить',
    saveAll: 'Сохранить всё',
    saveCurrent: 'Сохранить текущее',
    saved: 'Сохранённые снимки',
    saving: 'Сохранение снимка…',
    titlePrompt: 'Имя снимка',
    tabs: 'вкладок',
    windows: 'окон',
    updating: 'Обновление снимка…'
  },
  el: {
    allWindows: 'Αποθήκευση όλων των παραθύρων',
    appendCurrent: 'Προσθήκη στο τρέχον παράθυρο',
    cancel: 'Ακύρωση',
    currentWindow: 'Αποθήκευση τρέχοντος παραθύρου',
    deleteLabel: 'Διαγραφή στιγμιότυπου',
    deleting: 'Διαγραφή στιγμιότυπου…',
    duplicateConfirm: 'Οι περισσότερες καρτέλες αυτού του στιγμιότυπου είναι ήδη ανοιχτές. Να γίνει επαναφορά;',
    edit: 'Επεξεργασία στιγμιότυπου',
    empty: 'Δεν υπάρχουν αποθηκευμένα στιγμιότυπα.',
    emptyHint: 'Αποθηκεύστε το τρέχον παράθυρο ή όλα τα παράθυρα για επαναφορά αργότερα.',
    collapse: 'Σύμπτυξη',
    expand: 'Ανάπτυξη',
    latestSnapshot: 'Αυτόματο αντίγραφο',
    manual: 'Χειροκίνητα',
    openTab: 'Άνοιγμα αυτής της καρτέλας',
    pinned: 'Καρφιτσωμένη',
    muted: 'Σε σίγαση',
    recoverLatest: 'Επαναφορά τελευταίου αυτόματου αντιγράφου',
    restore: 'Επαναφορά σε νέο παράθυρο',
    restorePartial: 'Επαναφορά ολοκληρώθηκε με ορισμένες αποτυχίες',
    restoring: 'Επαναφορά στιγμιότυπου…',
    save: 'Αποθήκευση',
    saveAll: 'Αποθήκευση όλων',
    saveCurrent: 'Αποθήκευση τρέχοντος',
    saved: 'Αποθηκευμένα στιγμιότυπα',
    saving: 'Αποθήκευση στιγμιότυπου…',
    titlePrompt: 'Όνομα στιγμιότυπου',
    tabs: 'καρτέλες',
    windows: 'παράθυρα',
    updating: 'Ενημέρωση στιγμιότυπου…'
  },
  ko: {
    allWindows: '모든 창 저장',
    appendCurrent: '현재 창에 추가',
    cancel: '취소',
    currentWindow: '현재 창 저장',
    deleteLabel: '스냅샷 삭제',
    deleting: '스냅샷 삭제 중…',
    duplicateConfirm: '이 스냅샷의 대부분의 탭이 이미 열려 있습니다. 그래도 복원하시겠습니까?',
    edit: '스냅샷 편집',
    empty: '저장된 스냅샷이 없습니다.',
    emptyHint: '나중에 복원할 수 있도록 현재 창 또는 모든 창을 저장하세요.',
    collapse: '접기',
    expand: '펼치기',
    latestSnapshot: '자동 저장',
    manual: '수동',
    openTab: '이 탭 열기',
    pinned: '고정됨',
    muted: '음소거됨',
    recoverLatest: '최근 자동 저장 복원',
    restore: '새 창에서 복원',
    restorePartial: '일부 탭 실패와 함께 복원됨',
    restoring: '스냅샷 복원 중…',
    save: '저장',
    saveAll: '모두 저장',
    saveCurrent: '현재 저장',
